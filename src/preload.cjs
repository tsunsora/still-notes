...
const names=['init','choose','switch-repository','remove-repository','read','write','create','rename','move','place','set-icon','import','preferences','trash','reveal','external','window','window-state','ready-close','update-state','check-updates','install-update'];
